...
function fetchVideos (searchTerm) {
  ...
  'AIzaSyCY0VxsiG2tuPebTi48rLa9a__0j7nohyY'
...
for ( let i = 0; i < responseJSON.items.length; i++) {
  $('.video-results').empty();
      ...
      <h2>Watch a Trailer!!</h2>
        ...
        <iframe src = "https://www.youtube.com/embed/${responseJSON.items[i].id.videoId}" width = "300" height = "200" align = "middle" ></iframe>
        </div>
`)
}
}
